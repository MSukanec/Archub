              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="h-auto p-4 flex flex-col items-center gap-2 bg-[#d2d2d2] border-input hover:bg-[#c5c5c5] rounded-lg"
                  >
            ...
            {contact.email && (
              <div className="space-y-3">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full h-auto p-4 flex items-center gap-3 bg-[#d2d2d2] border-input hover:bg-[#c5c5c5] rounded-lg"
                >
