      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 h-10 bg-surface-secondary border-[#919191]/20 rounded-xl shadow-lg hover:shadow-xl transition-shadow focus:shadow-xl"
          />
        </div>
        <div className="flex items-center gap-2">
          <Select value={categoryFilter} onValueChange={setCategoryFilter}>
            <SelectTrigger className="w-48 h-10 bg-surface-secondary border-[#919191]/20 rounded-xl shadow-lg hover:shadow-xl">
