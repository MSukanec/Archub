          ...
          <div>
            ...
            <div className="relative">
              <Input
                ...
                className="h-10 bg-[#e1e1e1] border-[#919191]/20 focus:border-primary focus:ring-1 focus:ring-primary rounded-xl shadow-lg hover:shadow-xl transition-shadow pr-10"
              />
              <Button
                type="button"
                variant="ghost"
